...
add_action( 'header_parts', 'estore_header_nav_mobile', 20 );
function estore_header_nav_mobile() {
    get_template_part( 'template-parts/header/header-nav-mobile' );
}

add_action( 'header_parts', 'estore_header_text_mobile', 30 );
...
add_action( 'header_parts', 'estore_header_nav_desktop', 50 );
