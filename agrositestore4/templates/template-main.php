        ...
        <section>
            ...
            <div class="services-container">
                <div class="services-list">
                    <a href="#">
                        <img class="services-img" src="<?php echo get_stylesheet_directory_uri() ?>/assets/image/about-1-330x243.jpg" alt="agricultural machinery diagnostics">
                    </a>
                ...
                <div class="services-list">
                    <a href="#">
                        <img class="services-img" src="<?php echo get_stylesheet_directory_uri() ?>/assets/image/about-2-330x243.jpg" alt="tractor maintenance">
                    </a>
                    <div class="service-text-block1">
                ...
                <div class="services-list">
                    <a href="#">
                        <img class="services-img" src="<?php echo get_stylesheet_directory_uri() ?>/assets/image/about-3-330x243.jpg" alt="machinery repair">
                    </a>
                    <div class="service-text-block1">
                        <h1 class="h1-manepage">
                            <a href="#">
        ...
        <section>
            ...
            <div class="about-block">
                <div class="about-foto">
                    <img src="<?php echo get_stylesheet_directory_uri() ?>/assets/image/about-4-570x511.jpg" alt="agricultural machinery repair services">
                </div>
            ...
            <div class="news-block">
                <div class="news1">
                    <div class="news1-img-block">
                        <img class="news1-img" src="<?php echo get_stylesheet_directory_uri() ?>/assets/image/post-1-430x348.jpg">
                    </div>
                ...
                <div class="news-block-text">
                    <div class="news1-small">
                        <div class="news2-img-block">
                            <img class="news2-img" src="<?php echo get_stylesheet_directory_uri() ?>/assets/image/post-1-200x159.jpg">
                        </div>
                    ...
                    <div class="news2">
                        <div class="news2-img-block">
                            <img class="news2-img" src="<?php echo get_stylesheet_directory_uri() ?>/assets/image/post-2-200x159.jpg">
                        </div>
                        <div class="news2-text">
                            <div class="news-data">
                                August 9, 2019
                    ...
                    <div class="news3">
                        <div class="news2-img-block">
                            <img class="news2-img" src="<?php echo get_stylesheet_directory_uri() ?>/assets/image/post-3-200x159.jpg">
                        </div>
                        <div class="news2-text">
                            <div class="news-data">
                                August 9, 2019
